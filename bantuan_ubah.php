<?php
    ...
    $row = $db->get_row("SELECT * FROM tb_bantuan WHERE kode_bantuan='".$id."'"); 
?>
    ...
    <div class="col-sm-6">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kode_bantuan" value="<?=set_value('kode_bantuan', $row->kode_bantuan)?>"/>
            </div>
            <div class="form-group">
                <label>Nama bantuan <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama_bantuan" value="<?=set_value('nama_bantuan', $row->nama_bantuan)?>"/>
            </div>
            <div class="form-group">
